...
import styles from '../styles/LiveFromHarlem.module.css'
                    ...
                    <div className={`hide-scroll ${styles.scrollFeedContainer}`}>
                        ...
                        { isLoading ? <div className='centerDivItems'><Loader/></div> : (feedData && 
                                (
                                    ...
                                    :
                                    <div className='centerDivItems'>
                                        <h1 className={`color-primary ${fonts.mont}`} style={{fontWeight: 300}}>Dropping Soon!</h1>
                                    </div>
                                ))
                            }
                    </div>
                ...
                <div className={`${styles.containerGrid} ${fonts.mont}`}>
                    ...
                    <div className={styles.topCenter}>
                        <div style={{overflow: 'hidden', height: '100%'}}>
                            <img src='../images/flier.jpg' style={{height: 'auto', width: '100%'}}></img>
                        </div>
                    </div>

                    <div className={styles.bottomCenter}>
                        <div className={styles.playlistHeader}>
                            <h1 className='color-primary' style={{fontWeight: 'bold', fontSize: '30px', letterSpacing: '-1px'}}>Live From Harlem</h1>
                        </div>
                        <div className={`hide-scroll ${styles.scrollFeedContainer}`}>
                                        {/* <h1 className={`color-primary ${fonts.mont}`} style={{fontWeight: 300}}>Dropping Today</h1> */}
                            { isLoading ? <div className='centerDivItems'><Loader/></div> : (feedData && 
